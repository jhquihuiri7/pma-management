...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const adminDoc = await adminDb.collection("pg_admins").doc(session.user.id).get();
    ...
    const docRef = await adminDb.collection("pg_formats").add(formatData);
