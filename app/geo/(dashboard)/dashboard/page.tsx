...
export default function GeoDashboardPage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero */}
      <div className="bg-gradient-to-br from-teal-700 via-teal-600 to-emerald-700 px-8 pt-12 pb-20 relative overflow-hidden">
        <div
      ...
      <div className="max-w-5xl mx-auto px-8 -mt-10 pb-16">
        {/* Category tiles */}
