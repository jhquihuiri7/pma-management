...
import { getGenerations, bulkSetGenerations } from "../../modules/pglp/monthlyGenerationsModule.js";
...
export async function pglpMonthlyGenerationsRoutes(app: FastifyInstance) {
  app.addHook("preHandler", authenticate);
  app.addHook("preHandler", requireApp("pglp"));

  app.get("/", async (req) => getGenerations((req.params as any).planId));
