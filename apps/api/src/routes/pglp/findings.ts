...
import { createFinding, getFindingsByPlan, updateFinding, deleteFinding } from "../../modules/pglp/findingsModule.js";
...
export async function pglpFindingsRoutes(app: FastifyInstance) {
  ...
  app.post("/", { preHandler: requireRole("ADMIN") }, async (req, reply) => {
    ...
    reply.status(201);
    return createFinding(body.planId, u.sub, u.name, body);
  });
